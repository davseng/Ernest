...
export function createCloudToBoatSync({ endpoint, authorization = null, fetchImpl = fetch, knowledge, validatePackage = null }) {
  ...
  async function checkAndApply(){
    ...
    if(validatePackage) validatePackage(remote.package);
